...
This playbook is used to perform a Turbo IOC scan using manually entered IOCs or other IOCs from Google SecOps. [Download](<./playbooks/Rubrik Turbo IOC Scan.zip>)
...
- **Object Name:** The Object Name to fetch Sensitive Data hits for.
- **Cluster ID:** The Rubrik cluster ID associated with the object.

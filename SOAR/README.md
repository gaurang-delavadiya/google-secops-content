...
You can also download the [**All Playbook Bundle**](<./All Rubrik Security Cloud Playbooks.zip>) which includes all the Infoblox playbooks and blocks.
...
![Playbook - Rubrik Anomaly Analysis Input Block](<./screenshots/blocks/Rubrik Advanced IOC Scan Input Block.png>)
...
![Playbook - Rubrik File Context Analysis Input Block](<./screenshots/blocks/Rubrik Advanced IOC Scan Input Block.png>)
